...
def server_compute(server_number, message_board, server_table_1, server_table_2):
...
if __name__ == "__main__":
	...
	if len(sys.argv)<=2 :
		...
		server_table_1 = server_compute(0,message_board, server_table_1, server_table_2)
		server_table_2 = server_compute(1,message_board, server_table_1, server_table_2)
		# print(server_table_1)
